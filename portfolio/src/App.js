        ...
        <footer>
                ...
                <div className="collapse navbar-collapse justify-content-end" id="footerBar">
                    ...
                    <li className="nav-item">
                        <a href="https://github.com/Statikman619/Portfolio" target="_blank" className="btn btn-sm active" role="button"
                        aria-pressed="true">
                        <i className="fa fa-book"></i></a>
                    </li>
                    <li className="nav-item">
                        <a href="comingSoon" target="_blank" className="btn btn-sm" role="button"
                        aria-pressed="true">
                        <i className="fa fa-envelope-o e-mail-button"></i></a>
                    </li>
                    <li className="nav-item">
                        <a href="https://www.linkedin.com/in/michael-martinez-0863591b8/" target="_blank" className="btn btn-sm" role="button"
                        aria-pressed="true">
                        <i className="fa fa-linkedin-square"></i></a>
                    </li>
                    <li className="nav-item">
                        <a href="https://github.com/Statikman619" target="_blank" className="btn btn-sm" role="button" aria-pressed="true">
