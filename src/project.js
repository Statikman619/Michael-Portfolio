...
const projects = [
  {
    ...
    projectLinks: [
      {
        type: "Repository",
        url: "https://github.com/Statikman619/Work-Day-Scheduler",
      },
      {
        type: "Deployment",
        url: "https://statikman619.github.io/Work-Day-Scheduler/",
      },
    ],
    ...
    details:
      "An application that allows users to add important events to a daily planner. So that they can manage their time effectively.",
  },
  {
    id: 5,
    name: "movie-buffs",
    projectLinks: [
      {
        type: "Repository",
        url: "https://github.com/JG-77/Movie-Buffs-Group-Project",
      },
      {
        type: "Deployment",
    ...
    details:
      "An application that allows a user to do a quick search to help you learn about movies, tv series, and video games.",
  },
  {
    id: 4,
    name: "note-taker",
  ...
  },
  {
    ...
    projectLinks: [
      {
        type: "Repository",
        url: "https://github.com/Statikman619/Open-Weather-Map/tree/master",
      },
      {
        type: "Deployment",
        url: "https://statikman619.github.io/Open-Weather-Map/",
      },
    ],
    ...
    details:
      "An application called Open Weather Map that allows you to get current weather data from various cities",
  },
  {
    id: 2,
    ...
    projectLinks: [
      {
        type: "Repository",
        url: "https://github.com/Statikman619/Password-Generator",
      },
      {
        type: "Deployment",
        url: "https://statikman619.github.io/Password-Generator/",
      },
    ],
  ...
  },
  {
    ...
    projectLinks: [
      {
        type: "Repository",
        url: "https://github.com/Statikman619/Workout-Tracker",
      },
      {
        type: "Deployment",
        url: "https://mikes-workout-tracker.herokuapp.com/?id=60f798454d65b0001558decd",
      },
    ],
    ...
    details:
      "An application that allows a user to be able to view create and track daily workouts. I want to be able to log multiple exercises in a workout on a given day.",
  },
];
